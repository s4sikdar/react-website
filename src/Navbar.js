        ...
        return(
            <li className = "nav-item">
                <a className = {this.props.class} href = {this.state.href} 
                    ref = {this.current_ref} onClick = {this.scroll}>
                    {this.props.value}
                </a>
            </li>
        );
        ...
        return (
            <React.Fragment>
                <nav className = "navbar navbar-expand d-none d-lg-flex">
                    <ul role = 'navigation'
                    className = {`navbar-nav fixed-top ${this.state.at_roof ? 'transparent pr-3' : 'light shadow-sm'}\
                        ...
                        {this.props.values.map((value, index) => {
                            return (
                                ...
                                class = {
                                `${this.state.at_roof ? 'transparent-item mr-1 light-after' : 'nav-list-item light dark-after'}\
